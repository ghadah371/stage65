...
sudo -u azureuser /home/azureuser/stage65/venv/bin/pip install --upgrade pip
sudo -u azureuser /home/azureuser/stage65/venv/bin/pip install -r ${APP_DIR}/requirements.txt
